    ...
    window.addSushi = async () => {
      console.log('! ADD SUSHI !')
        try {
          ...
          const response = await fetch(`${process.env.API_BASE_URL}/admin/add`, {
            method: 'POST',
            headers: {
      ...
      window.deleteSushi = async () => {
        try {
          ...
          const response = await fetch(`${process.env.API_BASE_URL}/admin/delete/${sushiIdToDelete}`, {
            method: 'DELETE',
          });
      ...
      window.addBox = async () => {
        try {
          ...
          const response = await fetch(`${process.env.API_BASE_URL}/admin/addBox`, {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
            },
