    ...
    window.addSushi = async () => {
      ...
      window.deleteSushi = async () => {
        try {
          ...
          const response = await fetch(`${process.env.API_BASE_URL}/delete/${sushiIdToDelete}`, {
            method: 'DELETE',
          });
      ...
      window.addBox = async () => {
        try {
          ...
          const response = await fetch(`${process.env.API_BASE_URL}/addBox`, {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
            },
      ...
      window.deleteBox = async () => {
        try {
          ...
          const response = await fetch(`${process.env.API_BASE_URL}/deletebox/${boxIdToDelete}`, {
            method: 'DELETE',
          });
